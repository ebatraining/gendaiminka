...
$site_top = "http://client-info.net/gendaiminka/";
...
$Referer_check_domain = "client-info.net";
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://client-info.net/gendaiminka" target="_blank">- 現代民家 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
