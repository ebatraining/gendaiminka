...
$site_top = "http://client-info.net/gendaiminka/lp_10/";
...
$Referer_check_domain = "http://client-info.net";
...
$require = array('イベント名','第1希望日','第1希望時間','名前','フリガナ','Email','電話番号');
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://client-info.net/gendaiminka/lp_10" target="_blank">- 現代民家 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
